...
export default function Planos({}: Props) {
  return (
    <>
    <main className='bg-linear-to-b from-stone-900 to-black text-white flex flex-col justify-center items-center space-y-6 min-h-screen'>
        <h1>Planos Page</h1>
